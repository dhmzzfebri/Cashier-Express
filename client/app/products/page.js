...
export default function Products() {
  ...
  useEffect(() => {
    const ambilData = async () => {
      const ambil = await fetch('http://localhost:8000/api/v2/products');
          ...
          <>
            ...
            <Modal show={tampilkan}>
              ...
              <Modal.Body>
                ...
                <Form.Control type="number" id="inputPassword5" aria-describedby="passwordHelpBlock" value={formProduct.quantity} onChange={(e) => setFormProduct({ ...formProduct, quantity: e.target.value })} />
              </Modal.Body>
              <Modal.Body>
