...
class ProductController {
  ...
  setup() {
    this.app.post('/api/v2/products', this.create);
    this.app.get('/api/v2/products', this.findAll);
    this.app.put('/api/v2/products/:id', this.update);
    this.app.delete('/api/v2/products/:id', this.delete);
  }
